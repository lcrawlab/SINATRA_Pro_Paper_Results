    ...
    for offset in range(0,50,10):
        ...
        model = keras.Sequential(
            [
             ...
             layers.Dense(2048, activation="relu"),#, kernel_regularizer=keras.regularizers.l1_l2()),
             layers.BatchNormalization(),
             layers.Dense(512, activation="relu"),#, kernel_regularizer=keras.regularizers.l1_l2()),
             layers.BatchNormalization(),
             layers.Dense(128, activation="relu"),#, kernel_regularizer=keras.regularizers.l1_l2()),
             layers.BatchNormalization(),
        ...
        with tf.GradientTape() as tape:
            ...
            np.savetxt('no_reg/saliency_map_%s_offset_%d.txt'%(filename,offset),saliency_map)
